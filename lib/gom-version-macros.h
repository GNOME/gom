...
#define GOM_VERSION_1_0 (G_ENCODE_VERSION (1, 0))

#if GOM_MAJOR_VERSION == GOM_VERSION_1_0
#define GOM_VERSION_PREV_STABLE (GOM_VERSION_1_0)
#else
...
#if GOM_VERSION_MIN_REQUIRED >= GOM_VERSION_1_0
#define GOM_DEPRECATED_IN_1_0 GOM_DEPRECATED
#define GOM_DEPRECATED_IN_1_0_FOR(f) GOM_DEPRECATED_FOR(f)
#else
#define GOM_DEPRECATED_IN_1_0 _GOM_EXTERN
#define GOM_DEPRECATED_IN_1_0_FOR(f) _GOM_EXTERN
#endif
#if GOM_VERSION_MAX_ALLOWED < GOM_VERSION_1_0
#define GOM_AVAILABLE_IN_1_0 GOM_UNAVAILABLE(1, 0)
#else
#define GOM_AVAILABLE_IN_1_0 _GOM_EXTERN
#endif
